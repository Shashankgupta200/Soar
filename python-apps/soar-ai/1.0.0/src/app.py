...
class Tools(AppBase):
    ...
    def security_assistant(self):
        # Currently testing outside the Soar environment
        # using assistants and local LLMs

        return "Not implemented"

    def soar_cloud_inference(self, apikey, text, formatting="auto"):
        headers = {
        ...
        ret = requests.post(
            "https://soarr.io/api/v1/conversation", 
            json={
                "query": text, 
    ...
    def generate_report(self, apikey, input_data, report_title, report_name="generated_report.html"):
        ...
        # Make it into a soar file with self.set_files()
        new_file = {
            "name": report_name,
            "data": ret.text,
        }
