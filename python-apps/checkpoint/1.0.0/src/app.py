...
class CheckPoint(AppBase):
    ...
    def install_policy(self, ip_addr:str, user:str, password:str, policy_package:str, targets:str, ssl_verify)->"json":
        ...
        # this action has lots of optional parameters, add those when building for soar https://sc1.checkpoint.com/documents/latest/APIs/index.html#web/install-policy~v1.8%20
